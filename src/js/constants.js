...
const BIOGRAPHY_TEXT = "Software engineer and technical co-founder with extensive experience in designing, \
...
const MASTERS_DEGREE_TEXT = "<span><strong>Master's degree in Software Engineering and Computer Science from the Faculty of Organizational \
...
const BACHELORS_DEGREE_TEXT = "<span><strong>Bachelor's degree in Information Systems and Technologies from the Faculty \
...
const PROJECTS = {
    FOOTBALL_APP_TEXT: '<span>Web application built for organizing football matches and building social network of players. Developed using \
    ...
    BATTLESHIP_APP_TEXT: '<span>Recreation of famous battleship game built using Java, JavaFX, MySQL for desktop. It covers basic concepts of concurrent programming, threads and network programming conepts\
    ...
    MAGIC_MAP_APP_TEXT: '<span>Magic map task made for purpose of Escape room. It was inspired by Harry Potter movie. Developed using arduino nano.<br><br>\
    <a class="terminal-link" target="_blank" href="https://github.com/milosnikic/magic_map">Visit repository</a></span>',
    THERMALSYSTEM_APP_TEXT: '<span>Home automation application for controlling thermal system. Developed using arduino esp8266.<br><br>\
    <a class="terminal-link" target="_blank" href="https://github.com/milosnikic/esp8266-thermal-system">Visit repository</a></span>',
    ASCII_ART_APP_TEXT: '<span>Console application made for mastering pygame module. Idea is to enable user to insert image and get it\'s ASCII version. \
    ...
    CERBERUS_APP_TEXT: '<span>Web application built for statistics information about Balkan CSGO players.\
    ...
    CARVANA_ML_TEXT: '<span>Machine learning project which goal is to determine whether a car is a good or bad buy based\
    ...
    FAMILY_TREE_TEXT: '<span>Family tree visualization tool that renders family relationships in an interactive visual format.<br><br>\
    <a class="terminal-link" target="_blank" href="https://github.com/milosnikic/family_tree">Visit repository</a></span>',
    HL7_SERIALIZER_TEXT: '<span>HL7 Serializer implementation in C# for sending clinical information. Handles serialization \
    ...
    ZENCOIN_BLOCKCHAIN_TEXT: '<span>Simple blockchain implementation using JavaScript. Demonstrates core blockchain concepts \
    ...
    ROOM_LIGHTNING_TEXT: '<span>Arduino FreeRTOS project for under table lighting. Uses real-time operating system concepts \
...
const EXPERIENCE = {
    METASTACK_TEXT: '<span><strong>Metastack — Co-Founder & Core Backend Engineer</strong><br><br>\
    ...
    VORTEX_WEST_TEXT: '<span><strong>Vortex West — Software Developer (July 2022 - Present)</strong><br>Belgrade, Serbia<br><br>\
    ...
    TNATION_TEXT: '<span><strong>TNation — C# Backend Developer (Oct 2019 – July 2022)</strong><br>Belgrade, Serbia<br><br>\
    ...
    THINGS_SOLVER_TEXT: '<span><strong>Things Solver — Data Analyst, Internship (Apr – July 2019)</strong><br>Belgrade, Serbia<br><br>\
...
export { IGNORE_KEYS, KEYS, CURSOR_CHARACTER, HOST, BIOGRAPHY_TEXT, MASTERS_DEGREE_TEXT, BACHELORS_DEGREE_TEXT, PROJECTS, EXPERIENCE, COMMANDS, };
