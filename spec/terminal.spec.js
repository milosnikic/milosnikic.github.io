...
describe("Terminal", function () {
    ...
    describe("process input", function () {
        ...
        it("should return that command is not found", function () {
            const result = terminal.processInput("echo 'Hello'");
            expect(result.innerHTML).toBe('Command not found: "echo". Type "help" for more information.');
        });
        it("should return that command needs arguments when they are mandatory but not provided", function () {
            ...
            const result = terminal.execute();
            expect(spy).not.toHaveBeenCalled();
            expect(result.innerHTML).toBe('Command "cd" requires additional arguments. Type "help" for more information.');
        });
